...
class SlideActionState extends State<SlideAction> with TickerProviderStateMixin {
                          ...
                          children: <Widget>[
                            widget.submittedIcon ??
                                Icon(
                                  Icons.done,
                                  color:
                                      widget.innerColor ?? Theme.of(context).primaryIconTheme.color,
                                ),
                            Positioned.fill(
                              right: 0,
                              child: Transform(
  ...
  Future _checkAnimation() async {
    ...
    ).animate(CurvedAnimation(parent: _checkAnimationController, curve: Curves.slowMiddle));
  ...
  Future _shrinkAnimation() async {
    ...
    ).animate(CurvedAnimation(parent: _shrinkAnimationController, curve: Curves.easeOutCirc));
  ...
  Future _resizeAnimation() async {
    ...
    ).animate(CurvedAnimation(parent: _resizeAnimationController, curve: Curves.easeInBack));
  ...
  Future _cancelAnimation() async {
    ...
    ).animate(CurvedAnimation(parent: _cancelAnimationController, curve: Curves.fastOutSlowIn));
