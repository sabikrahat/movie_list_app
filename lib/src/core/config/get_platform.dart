...
class PlatformInfo {
  ...
  static PT get currentPlatformType => getCurrentPlatformType();
}

enum PT { isWeb, isIOS, isAndroid, isMacOS, isFuchsia, isLinux, isWindows, isUnknown }
...
extension PTExt on PT {
  ...
  bool get isDesktop =>
      this == PT.isMacOS || this == PT.isFuchsia || this == PT.isLinux || this == PT.isWindows;
